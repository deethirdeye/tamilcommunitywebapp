...
//         <Typography variant="h5">Aid View</Typography>
//         <Box>
//           {/* <Button variant="contained" color="primary" onClick={handleMemberDetails} sx={{ mr: 2 }}>Applicant Details</Button> */}
//           <Button variant="contained" color="primary" onClick={handleMarkAsUnderReview} sx={{ mr: 2 }}>Mark As Under Review</Button>
//           <Button variant="contained" color="warning" onClick={handleMarkAsOnHold} sx={{ mr: 2 }}>Mark as On Hold</Button>
...
//             <Grid item xs={6}>
//               <Typography>
//                 <strong>Request ID:</strong> {aidDetails.requestId}
//               </Typography>
//             </Grid>
//             <Grid item xs={6}>
//               <Typography>
//                 <strong>Type of Aid:</strong> {aidDetails.typeOfAid}
//               </Typography>
//             </Grid>
//             <Grid item xs={6}>
//               <Typography>
//                 <strong>Name:</strong> {aidDetails.name}
//               </Typography>
//             </Grid>
//             <Grid item xs={6}>
//               <Typography>
//                 <strong>Date Submitted:</strong> {aidDetails.dateSubmitted}
//               </Typography>
//             </Grid>
//             <Grid item xs={6}>
//               <Typography>
//                 <strong>Member Code:</strong> {aidDetails.memberCode}
//               </Typography>
//             </Grid>
//             <Grid item xs={6}>
//               <Typography>
//                 <strong>Aid For User Code:</strong> {aidDetails.aidForUserCode}
//               </Typography>
//             </Grid>
//             <Grid item xs={6}>
//               <Typography>
...
//               placeholder="Add a comment about the request process..."
//               sx={{ mb: 2 }}
//             />
...
//           <Button variant="outlined" sx={{ mr: 1 }} onClick={onBack}>Cancel</Button>
//           <Button variant="contained" color="error" sx={{ mr: 1 }} onClick={handleDenyClick}>Deny</Button>
//           <Button variant="contained" color="success" onClick={handleApproveClick}>Complete</Button>
//         </Box>
//       </Paper>
...
//         requestId={aidDetails.requestId}
//         name={aidDetails.name}
//         typeOfAid={aidDetails.typeOfAid}
//       />
//       <DenialConfirmationDialog
//         open={denialDialogOpen}
//         onClose={() => setDenialDialogOpen(false)}
